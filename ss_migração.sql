...
select (sum(r_content_size)/1048576.0) from engdo_documento_engenharia (all) where codigo_site = 'SS'
select (sum(r_content_size)/1000000.0) from engdo_documento_engenharia (all) where codigo_site = 'SS'
...
where eng.id_projeto = prj.r_object_id and prj.tipo = 'PR' and prj.codigo_site = 'KS' 
UNION
...
where prj.tipo = 'SE' and codigo_site = 'KS'
////////////////////////////////////////////////////////////////////////engso_tag///////////////////////////////////////////////////////////////////////////
//Pegar tags de site
