...
select r_object_id,i_antecedent_id, i_chronicle_id, r_version_label, r_creation_date, i_has_folder, a_content_type, r_link_cnt, object_name, title, id_projeto, numero_vale, id_empresa_projeto, codigo_site, observacoes, tipo_gr, nome_destinatario, nome_remetente
from engdo_gr (all)
where codigo_site = 'KM' 
order by i_chronicle_id, i_has_folder, r_creation_date
